...
public class EquipmentDTO {
    ...
    @Size(max = 5000, message = "Name must not exceed 255 characters")
    private String name;

    @NotBlank(message = "Inventory number is required")
    @Size(max = 5000, message = "Inventory number must not exceed 50 characters")
    ...
    @Size(max = 5000, message = "Access requirements must not exceed 255 characters")
