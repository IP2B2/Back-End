...
class RequestApprovalServiceTest {
    ...
    void testFindAll_Success() {
        ...
        when(requestApprovalRepository.findByAccessRequest_IdAndApprover_Id(accessRequest.getId(), approver.getId()))
    ...
    void testFindAll_Fail_EmptyList() {
        when(requestApprovalRepository.findByAccessRequest_IdAndApprover_Id(1L, 1L)).thenReturn(List.of());
